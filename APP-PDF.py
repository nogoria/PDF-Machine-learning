    ...
    def process_all_pdfs(self):
        ...
        for idx, filename in enumerate(self.pdf_files, start=1):
            ...
            for label, coords in self.label_box_stats.items():
                ...
                # aquí podrías descartar si pred_label != label; de momento se guarda igual
...
class LabelWindow(tk.Toplevel):
    ...
    def update_page_view(self):
        ...
        # scrollregion: tamaño completo de la página renderizada
    ...
    def zoom_in(self):
        self.zoom = min(self.zoom * 1.25, 6.0)  # límite superior
        self.update_page_view()

    def zoom_out(self):
        self.zoom = max(self.zoom / 1.25, 0.5)  # límite inferior
        self.update_page_view()
